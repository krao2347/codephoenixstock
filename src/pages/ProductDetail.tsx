          ...
          <CardContent>
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div className="grid gap-4 grid-cols-3">
                ...
                <div className="space-y-2">
                  <Label htmlFor="cost_price">Cost ({getCurrencySymbol()})</Label>
                  <Input
                    id="cost_price"
                    type="number"
                    step="0.01"
                ...
                <div className="space-y-2">
                  <Label htmlFor="selling_price">Selling Price ({getCurrencySymbol()})</Label>
                  <Input
                    id="selling_price"
                    type="number"
                    step="0.01"
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{product.name}"? This action cannot be undone and will remove all associated stock records.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
